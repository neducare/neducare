                        ...
                        <div class="eForm-layouts">
                            <form method="POST" class="col-12 live-class-settings-form" action="{{ route('admin.settings.payment_post') }}" id="live-class-settings-form">
                                ...
                                <div class="fpb-7">
                                    ...
                                    <input type="text" class="form-control eForm-control" id="test_secret_key" name = "test_secret_key" placeholder="Test Sectect Key" value="{{ $stripe_keys->test_secret_key }}" aria-label="Test Sectect Key" required>
                                </div>
                    ...
                    <div class="col-md-6 pb-3">
                        <div class="eForm-layouts">
                            <form method="POST" class="col-12 live-class-settings-form" action="{{ route('admin.settings.payment_post') }}" id="live-class-settings-form">
                                ...
                                <div class="fpb-7">
                                    <label for="test_secret_key" class="eForm-label">{{ get_phrase('Test Sectect Key') }}</label>
                                    <input type="text" class="form-control eForm-control" id="test_secret_key" name = "test_secret_key" placeholder="Test Sectect Key" value="{{ $razorpay_keys->test_secret_key }}" aria-label="Test Sectect Key" required>
                                </div>
