      ...
      <ul class="nav nav-tabs eNav-Tabs-custom pt-2" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button class="nav-link active" id="approve-tab" data-bs-toggle="tab" data-bs-target="#approvetable" type="button" role="tab" aria-controls="approvetable" aria-selected="false">
            <?php echo e(get_phrase('Active ')); ?><p class="badge bg-success"><?php echo e(count($active_packages)); ?></p><span></span>
          </button>
        </li>
              ...
              <tr>
                ...
                <td class="text-start">
                  <div class="adminTable-action">
                    ...
                    >
                      <li>
                        <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('superadmin.edit.package', ['id' => $active_package->id])); ?>', 'Edit active_Package')"><?php echo e(get_phrase('Edit')); ?></a>
                      </li>
                      <li>
                        <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('superadmin.package.delete', ['id' => $active_package->id])); ?>', 'undefined');"><?php echo e(get_phrase('Delete')); ?></a>
                      </li>
                    </ul>
                  </div>
                </td>
              ...
              <tr>
                ...
                <td class="text-start">
                  <div class="adminTable-action">
                    ...
                    >
                      <li>
                        <a class="dropdown-item" href="javascript:;" onclick="rightModal('<?php echo e(route('superadmin.edit.package', ['id' => $archive_package->id])); ?>', 'Edit archive_Package')"><?php echo e(get_phrase('Edit')); ?></a>
                      </li>
                      <li>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856139451/domains/neducare.com/public_html/resources/views/superadmin/package/package.blade.php ENDPATH**/ ?>