	                      ...
	                      <div class="eCard eCard-2">
	                        <div class="eCard-body">
	                          ...
	                          <div class="d-flex flex-column align-items-start align-items-md-center">
	                            <a href="#" class="eBtn eBtn-blue" id="btn-<?php echo $phrase->phrase; ?>" onclick="updatePhrase('<?php echo $phrase->phrase; ?>', '<?php echo e($current_editing_language); ?>', '<?php echo $phrase->id; ?>')"><?php echo e(get_phrase('Update')); ?></a>
	                          </div>
	                        </div>
	                      </div>
	                    </div>
...
<?php echo $__env->make('superadmin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856139451/domains/neducare.com/public_html/resources/views/superadmin/language/manage_language.blade.php ENDPATH**/ ?>