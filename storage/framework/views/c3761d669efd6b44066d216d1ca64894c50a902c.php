<div class="eoff-form">
	<form method="POST" enctype="multipart/form-data" class="d-block ajaxForm" action="<?php echo e(route('admin.create.noticeboard')); ?>">
		<?php echo csrf_field(); ?> 
		<div class="form-row">
			<div class="fpb-7">
	        ...
	        <div class="fpb-7">
	            <label for="start_date" class="eForm-label"><?php echo e(get_phrase('Start date')); ?><span class="required"></span></label>
	            <input type="text" class="form-control eForm-control inputDate" id="start_date" name="start_date" value="<?php echo e(date('m/d/Y')); ?>" />
	        </div>
		    ...
		    <div class="time-details-stuffs">
		    	...
		    	<div class="fpb-7">
		            ...
		            <input type="time" class="form-control eForm-control" id="start_time" name="start_time" value="<?php echo e(date('H:i', strtotime(date('H:i')))); ?>">
		        </div>

		        <div class="fpb-7">
		            <label for="end_date" class="eForm-label"><?php echo e(get_phrase('End date')); ?><span class="required"></span></label>
		            <input type="text" class="form-control eForm-control inputDate" id="end_date" name="end_date" value="<?php echo e(date('m/d/Y')); ?>" />
		        </div>

		        <div class="fpb-7">
		            <label for="end_time" class="eForm-label"><?php echo e(get_phrase('End time')); ?><span class="required"></span></label>
		            <input type="time" class="form-control eForm-control" id="end_time" name="end_time" value="<?php echo e(date('H:i', strtotime(date('H:i')))); ?>">
		        </div>
		    </div>
			...
			<div class="fpb-7">
				...
				<select name="show_on_website" id="show_on_website" class="form-select eForm-select eChoice-multiple-with-remove">
					<option value="1"><?php echo e(get_phrase('Show')); ?></option>
					<option value="0"><?php echo e(get_phrase('Do not need to show')); ?></option>
				</select>
			</div>
			...
			<div class="fpb-7 pt-2">
				<button class="btn-form" type="submit"><?php echo e(get_phrase('Save notice')); ?></button>
			</div>
		</div>
	</form>
</div>
...
</script><?php /**PATH /home/u856139451/domains/neducare.com/public_html/resources/views/admin/noticeboard/create.blade.php ENDPATH**/ ?>