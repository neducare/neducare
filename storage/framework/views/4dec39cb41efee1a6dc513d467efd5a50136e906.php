                        ...
                        <td>
                          <div class="adminTable-action">
                            ...
                            >
                              ...
                              <li>
                                <a class="dropdown-item" href="javascript:;" onclick="confirmModal('<?php echo e(route('admin.accountant.delete', ['id' => $accountant->id])); ?>', 'undefined');"><?php echo e(get_phrase('Edit')); ?></a>
                              </li>
                            </ul>
                          </div>
                        </td>
...
<?php echo $__env->make('admin.navigation', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u856139451/domains/neducare.com/public_html/resources/views/admin/accountant/accountant_list.blade.php ENDPATH**/ ?>